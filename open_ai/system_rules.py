...
Only output codes like USD, EUR, ILS, RUB, GBP, etc.
    ...
    "cityTo": """
    You are a helpful assistant.
    User's request contains from <country_from> to <city_to>. Find country_to matching city_to and response ONLY one JSON with no additional services and comments
    {
        "country_from":"<country_from name>"
        "country_to":"<country_to name>"
